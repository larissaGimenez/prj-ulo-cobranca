...
@section('content')
    <nav class="mb-3" aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active">SAC</li>
        </ol>
    </nav>

    <h2 class="text-bold text-body-emphasis mb-5">Atendimento ao Cliente (SAC)</h2>

    <div id="supports-table-container" data-list='{"valueNames":["name","created_at"],"page":10,"pagination":true}'>
        <div class="row align-items-center justify-content-between g-3 mb-4">
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative">
                        <input class="form-control search-input search" type="search" placeholder="Buscar ticket"
                            aria-label="Search" />
            ...
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    ...
                    <a href="#" class="btn btn-primary">
                        <span class="fas fa-plus me-2"></span>Novo Ticket
                    </a>
                </div>
            </div>
        </div>
                ...
                <table class="table table-sm fs-9 mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="sort align-middle" scope="col" data-sort="name" style="width:70%;">ASSUNTO / TICKET
                            </th>
