...
@section('content')
    ...
    <h2 class="text-bold text-body-emphasis mb-5">Gestão de Cobranças</h2>

    <div id="billings-table-container" data-list='{"valueNames":["name","created_at"],"page":10,"pagination":true}'>
        <div class="row align-items-center justify-content-between g-3 mb-4">
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative">
                        <input class="form-control search-input search" type="search" placeholder="Buscar cobrança"
                            aria-label="Search" />
                        ...
                        <tr>
                            <th class="white-space-nowrap fs-9 align-middle ps-0" style="max-width:20px;">
                                <div class="form-check mb-0 fs-8">
                                    <input class="form-check-input" id="checkbox-bulk-billings-select" type="checkbox"
                                        data-bulk-select='{"body":"billings-table-body"}' />
                                </div>
                            </th>
