...
@section('content')
    ...
    <h2 class="text-bold text-body-emphasis mb-5">Gestão Financeira</h2>

    <div id="finances-table-container" data-list='{"valueNames":["name","created_at"],"page":10,"pagination":true}'>
        <div class="row align-items-center justify-content-between g-3 mb-4">
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative">
                        <input class="form-control search-input search" type="search" placeholder="Buscar registro"
                            aria-label="Search" />
            ...
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    ...
                    <a href="#" class="btn btn-primary">
                        <span class="fas fa-plus me-2"></span>Novo Registro
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            <th class="white-space-nowrap fs-9 align-middle ps-0" style="max-width:20px;">
                                <div class="form-check mb-0 fs-8">
                                    <input class="form-check-input" id="checkbox-bulk-finances-select" type="checkbox"
                                        data-bulk-select='{"body":"finances-table-body"}' />
                                </div>
                            </th>
                            <th class="sort align-middle" scope="col" data-sort="name" style="width:70%;">DESCRIÇÃO</th>
