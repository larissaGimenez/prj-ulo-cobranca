            ...
            <div class="row flex-center h-100 g-0 px-4 px-sm-0">
                <div class="col col-sm-6 col-lg-7 col-xl-6">
                    ...
                    <div class="text-center">
                        <h4 class="text-body-highlight">{{ __('Esqueceu sua senha?') }}</h4>
                        <p class="text-body-tertiary mb-5">
                            {{ __('Digite seu e-mail abaixo e enviaremos um link para redefinir sua senha') }}
                        </p>
                        ...
                        <form method="POST" action="{{ route('password.email') }}"
                            ...
                            <button type="submit" class="btn btn-primary ms-2">
                                {{ __('Enviar') }}<span class="fas fa-chevron-right ms-2"></span>
                            </button>
                        </form>
