...
@section('content')
    ...
    <h2 class="text-bold text-body-emphasis mb-5">Gestão de Produtos</h2>

    <div id="products-table-container" data-list='{"valueNames":["name","created_at"],"page":10,"pagination":true}'>
        <div class="row align-items-center justify-content-between g-3 mb-4">
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative">
                        <input class="form-control search-input search" type="search" placeholder="Buscar produto"
                            aria-label="Search" />
            ...
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    ...
                    <a href="#" class="btn btn-primary">
                        <span class="fas fa-plus me-2"></span>Novo Produto
                    </a>
                </div>
            </div>
        </div>
                ...
                <table class="table table-sm fs-9 mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="sort align-middle" scope="col" data-sort="name" style="width:70%;">NOME DO PRODUTO
                            </th>
                                ...
                                <td class="fs-9 align-middle ps-0 py-3">
                                    <div class="form-check mb-0 fs-8">
                                        <input class="form-check-input" type="checkbox"
                                            data-bulk-select-row='{"id":{{ $product->id }}}' />
                                    </div>
                                </td>
